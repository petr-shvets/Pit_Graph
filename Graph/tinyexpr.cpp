...
double d_fmod(double x, double y)
{
	return fmod(x, y);
}
...
static const te_variable functions[] = {
    ...
    {"abs", d_fabs,     TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"acos", d_acos,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"asin", d_asin,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"atan", d_atan,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"atan2", d_atan2,  TE_FUNCTION2 | TE_FLAG_PURE, 0},
    {"ceil", d_ceil,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"cos", d_cos,      TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"cosh", d_cosh,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"e", e,          TE_FUNCTION0 | TE_FLAG_PURE, 0},
    {"exp", d_exp,      TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"fac", fac,      TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"floor", d_floor,  TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"ln", d_log,       TE_FUNCTION1 | TE_FLAG_PURE, 0},
#ifdef TE_NAT_LOG
    {"log", d_log,      TE_FUNCTION1 | TE_FLAG_PURE, 0},
#else
    {"log", d_log10,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
#endif
    {"log10", d_log10,  TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"ncr", ncr,      TE_FUNCTION2 | TE_FLAG_PURE, 0},
    {"npr", npr,      TE_FUNCTION2 | TE_FLAG_PURE, 0},
    {"pi", pi,        TE_FUNCTION0 | TE_FLAG_PURE, 0},
    {"pow", d_pow,      TE_FUNCTION2 | TE_FLAG_PURE, 0},
    {"sin", d_sin,      TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"sinh", d_sinh,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"sqrt", d_sqrt,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"tan", d_tan,      TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"tanh", d_tanh,    TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {0, 0, 0, 0}
};
        ...
        if ((s->next[0] >= '0' && s->next[0] <= '9') || s->next[0] == '.') {
            ...
            if (isalpha(s->next[0])) {
                ...
                switch (s->next++[0]) {
                    ...
                    case '^': s->type = TOK_INFIX; s->function = d_pow; break;
                    case '%': s->type = TOK_INFIX; s->function = d_fmod; break;
...
static te_expr *factor(state *s) {
    ...
    if (ret->type == (TE_FUNCTION1 | TE_FLAG_PURE) && ret->function == negate) {
		te_expr *se = (te_expr *)ret->parameters[0];
        free(ret);
        ret = se;
        neg = 1;
    }
    ...
    while (s->type == TOK_INFIX && (s->function == d_pow)) {
		te_fun2 t = (te_fun2)s->function;
        next_token(s);

        if (insertion) {
            /* Make exponentiation go right-to-left. */
			te_expr *insert = NEW_EXPR2(TE_FUNCTION2 | TE_FLAG_PURE, (te_expr *)(insertion->parameters[1]), power(s));
            insert->function = t;
...
static te_expr *term(state *s) {
    ...
    while (s->type == TOK_INFIX && (s->function == mul || s->function == divide || s->function == d_fmod)) {
		te_fun2 t = (te_fun2)s->function;
        next_token(s);
